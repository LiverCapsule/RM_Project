...
PID_Regulator_t LCM1SpeedPID = LIFTCHAIN_MOTOR_SPEED_PID_DEFAULT;
PID_Regulator_t LCM2SpeedPID = LIFTCHAIN_MOTOR_SPEED_PID_DEFAULT;
PID_Regulator_t LCM3SpeedPID = LIFTCHAIN_MOTOR_SPEED_PID_DEFAULT;
